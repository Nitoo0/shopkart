...
//                        .height(60.dp)
                    ...
                    Row(
                        ...
                        Text(
                            text = "ksh${DecimalFormat("#,##,###").format(((product_price - 280) / quantity).toDouble())}",
                            style = TextStyle(
                                fontSize = 18.sp,
                                fontWeight = FontWeight.Bold,
                                fontFamily = roboto
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(
                        ...
                        text = "Item Price: ksh${DecimalFormat("#,##,###").format(((product_price - 280) / quantity).toDouble())}",
                        style = TextStyle(
                            fontSize = 12.sp,
                            fontWeight = FontWeight.Bold,
                            fontFamily = roboto
                    ...
                    Text(
                        text = "Total Price: ksh${DecimalFormat("#,##,###").format(product_price.toDouble())} (Incl. all taxes)",
                        style = TextStyle(
                            fontSize = 16.sp,
                            fontWeight = FontWeight.Bold,
                            fontFamily = roboto
